...
int main (void)
{
	...
	int number_mean = 5, number_varience = 4;
	...
	output = open_file_write ();
		...
		//Calculates the mean
		mean_gpa = calculate_mean (sum_gpa, number_mean);
		mean_class_standing = calculate_mean (sum_class_standing, number_mean);
		mean_ages = calculate_mean (sum_ages, number_mean);
		...
		varience_gpa = calculate_variance (deviation_gpa1, deviation_gpa2, deviation_gpa3, deviation_gpa4, deviation_gpa5, number_varience);
